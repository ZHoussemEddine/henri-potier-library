...
const calculateReductionForOffer = (state: State, offer: CommercialOffer) => {
  switch (offer.type) {
    case "percentage": {
...
const saveOrder = (state: State) => {
  localStorage.setItem("order", JSON.stringify(state));
}

const orderReducer = (state: State, action: ActionDispatch): State => {
  switch (action.type) {
...
const OrderProvider = ({ children, stateInit }: OrderProviderProps) => {
